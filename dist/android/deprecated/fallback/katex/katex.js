        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var buildCommon_makeOrd = function makeOrd(group, options, type) {
                ...
                if (value.charCodeAt(0) === 0xD835) {
                    ...
                    var _wideCharacterFont = wide_character_wideCharacterFont(value, mode), _wideCharacterFont2 = slicedToArray_default()(_wideCharacterFont, 2), wideFontName = _wideCharacterFont2[0], wideFontClass = _wideCharacterFont2[1];
            ...
            var buildCommon_makeVList = function makeVList(params, options) {
                var _getVListChildrenAndD = buildCommon_getVListChildrenAndDepth(params), children = _getVListChildrenAndD.children, depth = _getVListChildrenAndD.depth;
            ...
            var buildCommon_staticSvg = function staticSvg(value, options) {
                ...
                var _svgData$value = slicedToArray_default()(svgData[value], 3), pathName = _svgData$value[0], width = _svgData$value[1], height = _svgData$value[2];
            ...
            var stretchy_svgSpan = function svgSpan(group, options) {
                ...
                function buildSvgSpan_() {
                    ...
                    if (utils.contains(["widehat", "widecheck", "widetilde", "utilde"], label)) {
                        ...
                        var _data = slicedToArray_default()(data, 3), paths = _data[0], _minWidth = _data[1], _viewBoxHeight = _data[2];
            ...
            defineFunction({
                ...
                handler: function handler(_ref3, args) {
                    var parser = _ref3.parser, breakOnTokenText = _ref3.breakOnTokenText;
                    var color = assertNodeType(args[0], "color-token");
            ...
            defineFunctionBuilders({
                ...
                htmlBuilder: function htmlBuilder(group, options) {
                    ...
                    var _group$value = group.value, valueBase = _group$value.base, valueSup = _group$value.sup, valueSub = _group$value.sub;
                ...
                createClass_default()(Parser, [{
                        ...
                        value: function parseImplicitGroup(breakOnTokenText) {
                            ...
                            if (func === "\\begin") {
                                ...
                                var _parseArguments = this.parseArguments("\\begin{" + envName + "}", env), args = _parseArguments.args, optArgs = _parseArguments.optArgs;
                                var context = {
                                    mode: this.mode,
                                    envName: envName,
                                    parser: this
                        ...
                        value: function parseGivenFunction(baseGroup, breakOnTokenText) {
                            if (baseGroup.type === "fn") {
                                ...
                                var _parseArguments2 = this.parseArguments(func, funcData), args = _parseArguments2.args, optArgs = _parseArguments2.optArgs;

#
#  Be sure to run `pod spec lint react-native-math-view.podspec' to ensure this is a
...
# s.license      = "MIT (example)"
  ...
  s.source       = { :git => "https://github.com/ShaMan123/react-native-math-view.git", :tag => "#{s.version}" }
